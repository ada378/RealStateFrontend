...
const chandraprabhaData = {
  name: 'Chandraprabha Realty',
  tagline: 'Premium Residential & Commercial Development',
  description: 'Chandraprabha Realty is a premier real estate division specializing in creating premium residential apartments, high-rise towers, and commercial spaces that define modern urban living. With a focus on quality construction, innovative design, and strategic locations in Lucknow and Noida, we have established ourselves as a trusted name in the real estate industry.',
  ...
  stats: [
    ...
    { number: '3000+', label: 'Happy Families' },
    { number: '10+', label: 'Years Experience' },
    { number: '500+', label: 'Cr. Revenue' }
  ],
  features: [
    { icon: FaBuilding, title: 'Premium Apartments', desc: 'Luxury 2, 3 & 4 BHK apartments with modern amenities' },
    { icon: FaLandmark, title: 'Commercial Complexes', desc: 'Grade-A commercial spaces for businesses' },
    { icon: FaMapMarkerAlt, title: 'Prime Locations', desc: 'Strategic placement in high-growth areas' },
    { icon: FaShieldAlt, title: 'Quality Assurance', desc: 'Superior construction with premium materials' },
    { icon: FaClock, title: 'On-Time Delivery', desc: 'Committed to project timelines' },
    { icon: FaHandshake, title: 'Transparent Deals', desc: 'Clear documentation and pricing' }
  ],
  amenities: [
    ...
    { icon: FaWifi, name: 'Smart WiFi' },
    { icon: FaTree, name: 'Green Parks' },
    { icon: FaShoppingBag, name: 'Retail Arcade' },
    { icon: FaHospital, name: 'Medical Facility' }
  ],
  projects: [
    { name: 'Chandraprabha Heights', location: 'Lucknow', type: 'Residential', status: 'Ready to Move', price: '₹45 L onwards', image: 'https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?w=600&q=80' },
    { name: 'Chandraprabha Grand', location: 'Noida', type: 'Residential', status: 'Under Construction', price: '₹68 L onwards', image: 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=600&q=80' },
    { name: 'Chandraprabha Business Park', location: 'Lucknow', type: 'Commercial', status: 'Ready to Move', price: '₹95 L onwards', image: 'https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?w=600&q=80' }
  ],
  testimonials: [
    { name: 'Rajesh Kumar', role: 'Software Professional', text: 'Chandraprabha Realty transformed our dream of owning a premium apartment into reality. The quality and attention to detail is exceptional.', rating: 5 },
    { name: 'Priya Sharma', role: 'Doctor', text: 'Excellent construction quality and timely delivery. The amenities provided are world-class. Highly recommended!', rating: 5 },
    { name: 'Amit Mishra', role: 'Business Owner', text: 'Our investment in Chandraprabha project has appreciated significantly. Great location and build quality.', rating: 5 }
  ],
  highlights: [
    'Vastu-compliant architectural designs',
    'IGBC/GRIHA certified green buildings',
    'Smart home automation ready',
    'Premium marble flooring',
    'World-class electrical fittings',
...
const DivisionSection = ({ data, id, isPrimary = false }) => {
  const [activeTab, setActiveTab] = useState('overview');
  
  return (
    <section className={`division-section ${id}`} id={id}>
      <div className="division-hero" style={{ backgroundImage: `linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.7)), url(${data.heroImage})` }}>
        <div className="division-hero-content">
          ...
          >
            <span className="division-tagline">{data.tagline}</span>
            <h1>{data.name}</h1>
...
const DivisionsPage = () => {
  ...
  const faqData = [
    { question: 'What is the booking process?', answer: 'Our booking process is simple and transparent. Visit our office or site, choose your preferred unit, pay the booking amount, and we will guide you through the entire documentation process.' },
    ...
    { question: 'What amenities are included?', answer: 'Our projects include a wide range of amenities like swimming pool, gym, clubhouse, parks, parking, security, and more depending on the project.' }
  ];
  ...
  return (
    <div className="divisions-page">
      ...
      <div id="chandraprabha"></div>
      <DivisionSection data={chandraprabhaData} id="chandraprabha" isPrimary={true} />
      <div id="qalagriha"></div>
      <DivisionSection data={qalagrihaData} id="qalagriha" />
      ...
      <section className="faq-section">
        <div className="container">
          ...
          >
            ...
            <p>Get answers to common queries about our projects</p>
          </motion.div>
